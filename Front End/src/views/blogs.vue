<template>
  <div class="container">
    <div id="page">
      ...
      <div class="featured" style="text-align:center"></div>
    </div>
      ...
      <div class="fh5co-post" :key="String(item.key)">
        <div class="fh5co-entry padding">
          <!-- <img
            :src="imgSrc"
          /> -->
          <img v-if="Math.random()*10>5" :src="imgSrc2"  ref="poster" style="width:'100px';height:'100px !important'"/>
          <img v-else :src="imgSrc1" ref="poster" style="width:'100px';height:'100px !important'" />
          <div>
            ...
            <Button
              class="editButton"
              type="dashed"
              @click="editBlogs(item.key)"
              >Go Edit</Button
            >
            <Button type="text" class="delButton" @click="delBlog(item.key)"
              >Delete</Button
            >
          </div>
        </div>
...
export default {
  data() {
    return {
      shouldClear: null,
      iconSize: "large",
      // imgSrc:`/images/project-${Math.random()*10 >>0}.jpg`,
      // current:1,
      imgSrc1: "",
      imgSrc2: "",
      searchValue: "",
